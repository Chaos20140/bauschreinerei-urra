export const impressum = {
  ...
  blocks: [
    ...
    },
    {
      ...
      body: 'Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: https://ec.europa.eu/consumers/odr/. Unsere E-Mail-Adresse finden Sie oben im Impressum. Wir sind nicht bereit oder verpflichtet, an einem Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.',
    },
    {
  ...
  blocks: [
    {
      ...
      body: 'Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können. Diese Website verarbeitet nur die Daten, die für ihren technischen Betrieb erforderlich sind, sowie freiwillig von Ihnen übermittelte Daten (z. B. bei Kontaktaufnahme per E-Mail oder Telefon).',
    },
    {
    ...
    },
    {
      ...
      body: 'Für die Anzeige unserer Kunden-Bewertungen sowie für den Empfang von Anfragen über unser Kontaktformular verwenden wir den Dienst Supabase (Supabase Inc., 970 Toa Payoh North #07-04, Singapore 318992). Die zugehörigen Daten sind auf Servern in der EU-Region (Frankfurt, Deutschland) gehostet. Beim Aufruf einer entsprechenden Seite wird eine Verbindung zu Supabase aufgebaut, um Inhalte zu laden bzw. Ihre Anfrage zu speichern — dabei können technische Verbindungsdaten (insbesondere Ihre IP-Adresse) verarbeitet werden. Die Verarbeitung erfolgt im Interesse einer ansprechenden Darstellung sowie der Anbahnung bzw. Erfüllung eines Vertrags (Art. 6 Abs. 1 lit. b und f DSGVO). Weitere Informationen: https://supabase.com/privacy.',
    },
    {
      heading: '9. Kontaktformular',
      body: 'Wenn Sie das Kontaktformular auf unserer Kontakt-Seite ausfüllen, werden die von Ihnen eingegebenen Daten (Name, E-Mail-Adresse, optional Telefonnummer und Objekt-Adresse, Projekttyp sowie Ihre Nachricht) zusammen mit Datum und Browser-Information in unserer Supabase-Datenbank gespeichert. Wir verwenden diese Angaben ausschließlich zur Bearbeitung Ihrer Anfrage. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO (Anbahnung oder Erfüllung eines Vertrags) sowie Ihre ausdrückliche Einwilligung in die Datenverarbeitung (Art. 6 Abs. 1 lit. a DSGVO), die Sie über die Checkbox am Ende des Formulars erteilen. Wir setzen ein verstecktes Honeypot-Feld zur Spam-Erkennung ein, das ausschließlich automatisierte Anfragen markiert — manuelle Eingaben werden dadurch nicht erfasst. Ihre Daten werden gelöscht, sobald Ihre Anfrage abschließend bearbeitet ist und keine gesetzlichen Aufbewahrungspflichten entgegenstehen. Sie haben das Recht, Ihre Einwilligung jederzeit zu widerrufen — eine kurze E-Mail an die im Impressum genannte Adresse genügt.',
    },
    {
    ...
    {
      heading: '9. Aktualität und Änderung',
      body: 'Diese Datenschutzerklärung ist aktuell gültig und hat den Stand Mai 2026. Durch die Weiterentwicklung unserer Website oder geänderte gesetzliche bzw. behördliche Vorgaben kann es notwendig werden, diese Datenschutzerklärung zu ändern. Die jeweils aktuelle Datenschutzerklärung kann jederzeit auf dieser Seite abgerufen werden.',
    },
  ],
} as const;

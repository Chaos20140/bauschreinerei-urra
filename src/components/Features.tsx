      ...
      <div className="max-w-7xl mx-auto">
        ...
        <ul className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-5">
          {features.items.map((f, idx) => {
            ...
            return (
              <BlurIn key={f.key} delay={idx * 0.07}>
                <li className="group relative h-full rounded-2xl border border-white/15 bg-white/[0.04] p-6 md:p-7 overflow-hidden transition-all duration-500 hover:bg-white/[0.08] hover:border-white/35 hover:-translate-y-1">
                  <div

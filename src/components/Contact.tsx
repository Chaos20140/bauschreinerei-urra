      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="grid md:grid-cols-12 gap-10">
          <BlurIn className="md:col-span-6 space-y-8">
            <div>
              ...
              <p className="text-white text-xl md:text-2xl">
                <Editable id="home.contact.address.value" rich>
            ...
            <div>
              ...
              >
                <Editable id="home.contact.phone.value">{contact.phone.display}</Editable>
              </a>
            </div>
            ...
            <div>
              ...
              >
                <Editable id="home.contact.email.value">{contact.email.display}</Editable>
              </a>
            </div>
          </BlurIn>
          ...
          <BlurIn className="md:col-span-5 md:col-start-8 flex flex-col justify-between gap-10" delay={0.15}>
            ...
            >
              <span className="text-base md:text-lg"><Editable id="home.contact.cta">{contact.cta}</Editable></span>
